...
type AuthorServiceClient interface {
	...
	IndexAuthor(ctx context.Context, in *IndexAuthorRequest, opts ...grpc.CallOption) (*IndexAuthorResponse, error)
}
...
func (c *authorServiceClient) IndexAuthor(ctx context.Context, in *IndexAuthorRequest, opts ...grpc.CallOption) (*IndexAuthorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IndexAuthorResponse)
	err := c.cc.Invoke(ctx, AuthorService_IndexAuthor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorServiceServer interface {
	...
	IndexAuthor(context.Context, *IndexAuthorRequest) (*IndexAuthorResponse, error)
...
func (UnimplementedAuthorServiceServer) IndexAuthor(context.Context, *IndexAuthorRequest) (*IndexAuthorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IndexAuthor not implemented")
}
...
func _AuthorService_IndexAuthor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IndexAuthorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorServiceServer).IndexAuthor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorService_IndexAuthor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorServiceServer).IndexAuthor(ctx, req.(*IndexAuthorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IndexAuthor",
			Handler:    _AuthorService_IndexAuthor_Handler,
		},
	},
