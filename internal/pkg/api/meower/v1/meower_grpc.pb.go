...
const (
	MeowerSvc_Salutation_FullMethodName = "/meower.v1.MeowerSvc/Salutation"
...
type MeowerSvcClient interface {
	Salutation(ctx context.Context, in *SalutationRequest, opts ...grpc.CallOption) (*SalutationResponse, error)
...
func (c *meowerSvcClient) Salutation(ctx context.Context, in *SalutationRequest, opts ...grpc.CallOption) (*SalutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SalutationResponse)
	err := c.cc.Invoke(ctx, MeowerSvc_Salutation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MeowerSvcServer interface {
	Salutation(context.Context, *SalutationRequest) (*SalutationResponse, error)
...
func (UnimplementedMeowerSvcServer) Salutation(context.Context, *SalutationRequest) (*SalutationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Salutation not implemented")
}
...
func _MeowerSvc_Salutation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SalutationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MeowerSvcServer).Salutation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MeowerSvc_Salutation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeowerSvcServer).Salutation(ctx, req.(*SalutationRequest))
	}
...
var MeowerSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Salutation",
			Handler:    _MeowerSvc_Salutation_Handler,
		},
		{
			MethodName: "Create",
